...
proto.FilesList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.FileName.toObject, includeInstance)
  };
...
proto.FilesList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.FileName.serializeBinaryToWriter
    );
  }
};
...
proto.FilesList.prototype.addNames = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.FileName, opt_index);
};
 ...
 * @return {string}
 */
proto.FileUploadRequest.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.FileUploadRequest.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.FileUploadRequest.prototype.getContent = function() {
 ...
 * @return {string}
 */
proto.FileUploadRequest.prototype.getContent_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.FileUploadRequest.prototype.getContent_asU8 = function() {
 ...
 * @return {!proto.FileUploadRequest} returns this
 */
proto.FileUploadRequest.prototype.setContent = function(value) {
