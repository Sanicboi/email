...
export class FirstMessageGenerationRequest extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.userData.length) writer.writeString(1, this.userData);
  ...
  static deserialize(
    ...
    const reader =
      ...
      message = new FirstMessageGenerationRequest();
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new MessageGenerationResult();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class InputEvaluationRequest extends pb_1.Message {
  ...
  static fromObject(data: { text?: string }): InputEvaluationRequest {
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new InputEvaluationRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new ResponseGenerationRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class OutputEvaluationRequest extends pb_1.Message {
  ...
  static fromObject(data: { id?: string }): OutputEvaluationRequest {
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new OutputEvaluationRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
