...
const { toString: mt } = Object.prototype,
  ...
  { iterator: ne, toStringTag: ve } = Symbol,
  re = ((e) => (t) => {
    const n = mt.call(t);
    return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
  })(Object.create(null)),
  k = (e) => ((e = e.toLowerCase()), (t) => re(t) === e),
  se = (e) => (t) => typeof t === e,
  { isArray: H } = Array,
  J = se("undefined");
function W(e) {
...
const yt = se("string"),
  ...
  At = k("URLSearchParams"),
  [xt, Ct, Nt, Pt] = ["ReadableStream", "Request", "Response", "Headers"].map(
    k,
  ),
  Ut = (e) =>
...
function Wt(e) {
  return !!(e && N(e.append) && e[ve] === "FormData" && e[ne]);
}
const Kt = (e) => {
  ...
  Xt = k("AsyncFunction"),
  Gt = (e) => e && (K(e) || N(e)) && N(e.then) && N(e.catch),
  Ve = ((e, t) =>
    e
      ? setImmediate
      : t
...
function oe(e, t, n) {
  ...
  function u(m, b, h) {
    ...
    if (m && !h && typeof m == "object") {
      if (a.endsWith(b, "{}"))
        ...
        (a.isArray(m) && en(m)) ||
        ((a.isFileList(m) || a.endsWith(b, "[]")) && (T = a.toArray(m)))
      )
        return (
          (b = Je(b)),
    ...
    return he(m) ? !0 : (t.append(Oe(h, b, o), c(m)), !1);
  }
  const d = [],
    S = Object.assign(tn, {
      defaultVisitor: u,
  ...
  function O(m, b) {
    if (!a.isUndefined(m)) {
      ...
      (d.push(m),
        a.forEach(m, function (T, A) {
          (!(a.isUndefined(T) || T === null) &&
            s.call(t, T, a.isString(A) ? A.trim() : A, b, S)) === !0 &&
            O(T, b ? b.concat(A) : [A]);
        }),
        d.pop());
    }
...
const Xe = {
  ...
  cn = (Se && window.location.href) || "http://localhost",
  fn = Object.freeze(
    ...
    return (
      ...
      f
        ...
        : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
          t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = mn(s[i])),
          !l)
    );
  }
...
const G = {
  ...
  transformResponse: [
    function (t) {
      const n = this.transitional || G.transitional,
...
let P = class {
  ...
  set(t, n, r) {
    ...
    else if (a.isString(t) && (t = t.trim()) && !gn(t)) i(bn(t), n);
...
function M(e, t) {
  ...
  function s(c, u, d, S) {
    if (a.isUndefined(u)) {
      if (!a.isUndefined(c)) return r(void 0, c, d, S);
    } else return r(c, u, d, S);
  }
  function o(c, u) {
...
const et = (e) => {
    ...
    ((t.headers = i = P.from(i)),
      (t.url = Ke(
        Ye(t.baseURL, t.url, t.allowAbsoluteUrls),
        e.params,
        e.paramsSerializer,
      )),
      l &&
    ...
    if (
      C.hasStandardBrowserEnv &&
      (r && a.isFunction(r) && (r = r(t)), r || (r !== !1 && An(t.url)))
    ) {
      const c = s && o && xn.read(o);
      c && i.set(s, c);
    }
    return t;
  },
  ...
  Un =
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        let { responseType: l, onUploadProgress: f, onDownloadProgress: c } = s,
          u,
          d,
          S,
          O,
        ...
        ("onloadend" in h
          ...
          (h.onabort = function () {
            h &&
              (r(new g("Request aborted", g.ECONNABORTED, e, h)), (h = null));
          }),
          (h.onerror = function () {
          ...
          "setRequestHeader" in h &&
            a.forEach(i.toJSON(), function (U, y) {
              h.setRequestHeader(y, U);
            }),
          a.isUndefined(s.withCredentials) ||
            (h.withCredentials = !!s.withCredentials),
          l && l !== "json" && (h.responseType = s.responseType),
          c && (([S, m] = ee(c, !0)), h.addEventListener("progress", S)),
          f &&
            h.upload &&
            (([d, O] = ee(f)),
    ...
    if (t || n) {
      ...
      const o = function (c) {
        if (!s) {
          ...
          r.abort(
            u instanceof g ? u : new V(u instanceof Error ? u.message : u),
          );
        }
      };
      let i =
  ...
  Ln = async function* (e, t) {
    for await (const n of Bn(e)) yield* kn(n, t);
  },
  Bn = async function* (e) {
  ...
  tt = ie && typeof ReadableStream == "function",
  Dn =
    ie &&
  ...
  ke = 64 * 1024,
  be = tt && nt(() => a.isReadableStream(new Response("").body)),
  te = { stream: be && ((e) => e.body) };
ie &&
  ((e) => {
    ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((t) => {
      !te[t] &&
        (te[t] = a.isFunction(e[t])
          ? (n) => n[t]()
          : (n, r) => {
              throw new g(
...
const vn = async (e) => {
    ...
    if (a.isSpecCompliantForm(e))
      return (
        await new Request(C.origin, { method: "POST", body: e }).arrayBuffer()
      ).byteLength;
  ...
  qn =
    ...
    (async (e) => {
      ...
      let O = Fn([s, o && o.toAbortSignal()], i),
        m;
      const b =
        O &&
        O.unsubscribe &&
      ...
      try {
        if (
          ...
          let y = new Request(t, { method: "POST", body: r, duplex: "half" }),
            p;
          if (
            (a.isFormData(r) &&
        ...
        let A = await fetch(m, S);
        const x = be && (c === "stream" || c === "response");
        if (be && (l || (x && b))) {
          const y = {};
          ["status", "statusText", "headers"].forEach((le) => {
            y[le] = A[le];
          });
          const p = a.toFiniteNumber(A.headers.get("content-length")),
            [R, L] = (l && Ne(p, ee(Pe(l), !0))) || [];
          A = new Response(
            Fe(A.body, ke, R, () => {
              (L && L(), b && b());
            }),
        ...
        c = c || "text";
        let U = await te[a.findKey(te, c) || "text"](A, e);
        return (
          !x && b && b(),
        ...
        throw (
          ...
          T && T.name === "TypeError" && /Load failed|fetch/i.test(T.message)
            ? Object.assign(new g("Network Error", g.ERR_NETWORK, e, m), {
                cause: T.cause || T,
              })
            : g.from(T, T && T.code, e, m)
        );
      }
    }),
  we = { http: Yt, xhr: Un, fetch: qn };
a.forEach(we, (e, t) => {
  if (e) {
    try {
  ...
  rt = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !In(n) && ((r = we[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
const Y = { assertOptions: Mn, validators: ae },
  D = Y.validators;
let I = class {
  constructor(t) {
    ((this.defaults = t || {}),
  ...
  _request(t, n) {
    ...
    (r !== void 0 &&
      ...
      s != null &&
        (a.isFunction(s)
          ...
          : Y.assertOptions(
              s,
              { encode: D.function, serialize: D.function },
              !0,
            )),
    ...
    this.interceptors.request.forEach(function (b) {
      (typeof b.runWhen == "function" && b.runWhen(n) === !1) ||
        ((f = f && b.synchronous), l.unshift(b.fulfilled, b.rejected));
    });
    const c = [];
    ...
    if (!f) {
      ...
      for (
        m.unshift(...l), m.push(...c), S = m.length, u = Promise.resolve(n);
        d < S;
    ...
    for (d = 0, S = c.length; d < S; ) u = u.then(c[d++], c[d++]);
    return u;
  }
  getUri(t) {
    t = M(this.defaults, t);
...
a.forEach(["delete", "get", "head", "options"], function (t) {
  I.prototype[t] = function (n, r) {
    return this.request(
      M(r || {}, { method: t, url: n, data: (r || {}).data }),
    );
  };
});
...
function it(e) {
  const t = new I(e),
    n = _e(I.prototype.request, t);
  return (
    a.extend(n, I.prototype, t, { allOwnKeys: !0 }),
  ...
  Zn = at({
    ...
    setup(e) {
      const t = lt({
        ...
        d = _(""),
        S = () => {
          const y = s.value?.files;
          r.value = y && y.length > 0 ? y[0] : null;
        },
        O = (y) => {
          switch (y) {
            case 1:
              return "Новый (без сообщения)";
            case 2:
              return "Получил сообщение";
            case 3:
              return "Ведет диалог";
            case 4:
              return "Завершил диалог";
            default:
              return "Ошибка";
          }
        };
      ct(async () => {
        try {
          {
            const y = await E.get("/api/config");
            ((t.attempts = y.data.attempts),
              (t.responseRating = y.data.responseRating),
              (t.sendRating = y.data.sendRating),
              (t.specialRating = y.data.specialRating),
              (t.topic = y.data.topic),
              (t.waitTime = y.data.waitTime));
          }
          {
            const y = await E.get("/api/ai/files");
            n.value = y.data.files;
          }
          {
            const y = await E.get("/api/ai/prompt");
            o.value = y.data.prompt;
          }
          {
            const y = await E.get("/api/users");
            c.value = y.data;
          }
          {
            const y = await E.get("/api/ai/model");
            l.value = y.data.model;
          }
        } catch (y) {
          console.error(y);
        }
      ...
      const m = async () => {
          await E.put("/api/config", JSON.parse(JSON.stringify(t)));
        },
        b = async () => {
          if (!r.value) return;
          const y = new FormData();
          (y.append("file", r.value),
            await E.post("/api/ai/files", y, {
              headers: { "Content-Type": "multipart/form-data" },
            }));
        },
        h = async (y) => {
          await E.delete(`/api/ai/files/${y}`);
        },
        T = async () => {
          await E.put("/api/ai/prompt", { prompt: o.value });
        },
        A = async () => {
          await E.put("/api/ai/model", { model: l.value });
        },
        x = async () => {
          await E.post("/api/mail", { amount: f.value });
        },
        U = async () => {
          (c.value.push({
            data: d.value,
            ...
            await E.post("/api/users", { email: u.value, data: d.value }));
        };
      return (y, p) => (
        j(),
        v("div", null, [
          p[24] || (p[24] = w("h1", null, "Пульт управления", -1)),
          w(
            "form",
            {
              class: "block",
              onSubmit: p[6] || (p[6] = ft(() => {}, ["prevent"])),
            },
            [
              p[12] || (p[12] = w("h2", null, "Конфигурация", -1)),
              p[13] ||
                (p[13] = w(
                  "label",
                  { for: "responseRating" },
                  "Рейтинг для генерации ответа",
                  -1,
                )),
              F(
                w(
                ...
                [[B, t.responseRating, void 0, { number: !0 }]],
              ),
              p[14] ||
                (p[14] = w(
                  "label",
                  { for: "specialRating" },
                  'Рейтинг для статуса "особый"',
                  -1,
                )),
              F(
                w(
                ...
                [[B, t.specialRating, void 0, { number: !0 }]],
              ),
              p[15] ||
                (p[15] = w(
                  "label",
                  { for: "sendRating" },
                  "Рейтинг для отправки ответа",
                  -1,
                )),
              F(
                w(
                ...
                [[B, t.sendRating, void 0, { number: !0 }]],
              ),
              p[16] ||
                (p[16] = w(
                  "label",
              ...
              F(
                ...
                [[B, t.waitTime, void 0, { number: !0 }]],
              ),
              p[17] ||
                (p[17] = w(
                  "label",
                  { for: "attempts" },
                  "Количество попыток генерации ответа",
                  -1,
                )),
              F(
                w(
                ...
                [[B, t.attempts, void 0, { number: !0 }]],
              ),
              p[18] ||
                (p[18] = w("label", { for: "topic" }, "Тема письма", -1)),
              F(
                w(
                  "input",
                  {
              ...
              w("button", { onClick: m }, "Сохранить"),
            ],
            32,
          ),
          w("div", zn, [
            p[19] || (p[19] = w("h2", null, "Файлы", -1)),
            (j(!0),
            v(
              ue,
              null,
              ce(
                ...
                (R, L) => (
                  j(),
                  v("div", { class: "file", key: L }, [
                    w("p", null, $(R), 1),
                    w("button", { onClick: (le) => h(R) }, "Удалить", 8, Jn),
                  ])
                ),
              ),
              128,
            ...
            w("button", { onClick: b }, "Добавить"),
          ]),
          w("div", Wn, [
            p[20] || (p[20] = w("h2", null, "Промпт", -1)),
            F(
              w(
                "textarea",
                {
                  name: "prompt",
                  "onUpdate:modelValue": p[7] || (p[7] = (R) => (o.value = R)),
                },
                null,
                512,
              ),
            ...
            w("button", { onClick: T }, "Сохранить"),
          ]),
          w("div", Kn, [
            p[21] || (p[21] = w("h2", null, "Модель", -1)),
            F(
              w(
                "select",
                {
                  "onUpdate:modelValue": p[8] || (p[8] = (R) => (l.value = R)),
                  name: "",
                  id: "",
                },
                [
          ...
          w("div", Gn, [
            ...
            v(
              ...
              ce(
                ...
                (R, L) => (
                  j(),
                  v("div", { class: "user", key: L }, [
                    w("p", null, "Имейл: " + $(R.email), 1),
                    w("p", null, "Данные: " + $(R.data), 1),
                    w("p", null, "Статус: " + $(O(R.status)), 1),
                  ])
                ),
              ),
              128,
            )),
            p[22] || (p[22] = w("h2", null, "Добавить пользователя", -1)),
            F(
              w(
                "input",
                {
                  "onUpdate:modelValue": p[9] || (p[9] = (R) => (u.value = R)),
                  type: "email",
                  placeholder: "имейл",
                },
                null,
          ...
          w("div", Qn, [
            ...
            F(
              ...
              [[B, f.value, void 0, { number: !0 }]],
            ),
            w("button", { onClick: x }, "Запустить рассылку"),
          ]),
        ])
      );
    },
  }),
  wr = pt(Zn, [["__scopeId", "data-v-4d9ad211"]]);
